...
///
/// **[OccupationRamp] was deleted in v2.0's phase 5 and restored the same
/// evening.** #9 replaced the Occupation chart with a grid, which left the ramp
/// with no caller; the field then said the chart was wanted *adjusted* rather
/// than removed, so both surfaces exist and the stack needs its colours again.
/// The deletion was right about one thing and it still holds: the ramp is for an
/// ordered quantity and nothing else, and the grid's bands are [FlowStatus].
///
